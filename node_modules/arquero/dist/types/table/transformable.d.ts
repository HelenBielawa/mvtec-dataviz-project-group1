...
export default class Transformable {
     ...
     */
    params(values?: Params, ...args: any[]): Transformable | {
        [x: string]: any;
    };
    /**
     ...
     */
    count(options?: CountOptions): this;
    /**
     ...
     */
    derive(values: ExprObject, options?: DeriveOptions): this;
    /**
     ...
     */
    filter(criteria: TableExpr): this;
    /**
     ...
     */
    relocate(columns: Selection, options: RelocateOptions): this;
    /**
     ...
     */
    sample(size: number | TableExpr, options?: SampleOptions): this;
    /**
     ...
     */
    impute(values: ExprObject, options?: ImputeOptions): this;
    /**
     ...
     */
    fold(values: ExprList, options?: FoldOptions): this;
    /**
     ...
     */
    pivot(keys: ExprList, values: ExprList, options?: PivotOptions): this;
    /**
     ...
     */
    spread(values: ExprList, options?: SpreadOptions): this;
    /**
     ...
     */
    unroll(values: ExprList, options?: UnrollOptions): this;
    /**
     ...
     */
    lookup(other: TableRef, on?: JoinKeys, ...values: ExprList[]): this;
    /**
     ...
     */
    join(other: TableRef, on?: JoinPredicate, values?: JoinValues, options?: JoinOptions): this;
    /**
     ...
     */
    join_left(other: TableRef, on?: JoinPredicate, values?: JoinValues, options?: JoinOptions): this;
    /**
     ...
     */
    join_right(other: TableRef, on?: JoinPredicate, values?: JoinValues, options?: JoinOptions): this;
    /**
     ...
     */
    join_full(other: TableRef, on?: JoinPredicate, values?: JoinValues, options?: JoinOptions): this;
    /**
     ...
     */
    cross(other: TableRef, values?: JoinValues, options?: JoinOptions): this;
    /**
     ...
     */
    semijoin(other: TableRef, on?: JoinPredicate): this;
    /**
     ...
     */
    antijoin(other: TableRef, on?: JoinPredicate): this;
    /**
     ...
     * @example table.intersect([other1, other2])
     */
    intersect(...tables: TableRef[]): this;
    /**
 ...
 */
export type TableFunc2 = (a?: Struct, b?: Struct, $?: Params) => any;
/**
 ...
 */
export type SelectHelper = (table: any) => string[];
/**
 ...
 */
export type TableRef = Transformable | string;
/**
 ...
 */
export type JoinList = [ExprList] | [ExprList, ExprList] | [ExprList, ExprList, Expr2Object];
/**
...
export type CountOptions = {
    /**
     * The name of the output count column.
     */
    as?: string;
};
/**
...
export type DeriveOptions = {
    /**
     * A flag indicating if the original
...
export type SampleOptions = {
    /**
     * Flag for sampling with replacement.
     */
    replace?: boolean;
    /**
     * Flag to ensure randomly ordered rows.
     */
    shuffle?: boolean;
    /**
     * Column values to use as weights
     ...
     * a table expression compatible with {@link Transformablederive }.
     */
 ...
 */
export type ImputeOptions = {
    /**
     * Column values to combine to impute missing
     ...
     * pairs, with valid table expressions for {@link Transformablerollup }.
...
export type PivotOptions = {
    /**
     * The maximum number of new columns to generate.
     */
    limit?: number;
    /**
     * A string to place between multiple key names.
     */
    keySeparator?: string;
    /**
     * A string to place between key and value names.
     */
    valueSeparator?: string;
    /**
     * Flag for alphabetical sorting of new column names.
     */
    sort?: boolean;
};
/**
...
export type SpreadOptions = {
    /**
     * Flag indicating if input columns to the
     * spread operation should be dropped in the output table.
     */
    drop?: boolean;
    /**
     * The maximum number of new columns to
     * generate.
     */
    limit?: number;
    /**
     * Output column names to use. This option only
...
export type UnrollOptions = {
    /**
     * The maximum number of new rows
     * to generate per array value.
     */
    limit?: number;
    /**
     * Flag or column name for adding
    ...
    /**
     * Columns to drop from the output. The input may
...
export type JoinOptions = {
    /**
     * Flag indicating a left outer join.
     * If both the *left* and *right* are true, indicates a full outer join.
     */
    left?: boolean;
    /**
     * Flag indicating a right outer join.
     * If both the *left* and *right* are true, indicates a full outer join.
     */
    right?: boolean;
    /**
     * Column name suffixes to
